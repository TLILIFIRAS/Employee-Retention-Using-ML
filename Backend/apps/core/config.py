...
class Config:
    ...
    * ----------      -----------    -------  ------------------------------
    * firas tlili    10-15-2023       1.0     initial creation
    *
    *
    * description:    Class declaration file  for configuration instance attributes
    *
    ****************************************************************************
    """
    ...
    def get_run_id(self):
        """
        * method: get_run_id
        * description: method to generate run ids
        * return: none
        *
        * who             when           version  change (include bug# if apply)
        * ----------      -----------    -------  ------------------------------
